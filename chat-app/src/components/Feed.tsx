    ...
    <div className="space-y-4 sm:space-y-5">
      <div className="flex items-center gap-1 sm:gap-2 border-b border-border/40 pb-2 mb-4">
        <Button
          ...
          className={`font-medium text-base h-9 px-3 rounded-md transition-colors ${activeTab === 'relevant'
        ...
        <Button
          ...
          className={`font-medium text-base h-9 px-3 rounded-md transition-colors ${activeTab === 'latest'
            ? 'font-bold text-[#3b49df] bg-card shadow-2xs border border-border/60'
            : 'text-muted-foreground hover:text-foreground hover:bg-muted/60'
            }`}
        >
        ...
        <Button
          ...
          className={`font-medium text-base h-9 px-3 rounded-md transition-colors ${activeTab === 'top'
            ? 'font-bold text-[#3b49df] bg-card shadow-2xs border border-border/60'
            : 'text-muted-foreground hover:text-foreground hover:bg-muted/60'
            }`}
        >
