    ...
    <div className="space-y-6 pb-8">
      ...
      {loading && users.length === 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          {[1, 2, 3, 4, 5, 6].map(n => (
            <div key={n} className="bg-card border border-border/80 rounded-md h-64 animate-pulse" />
          ))}
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="pt-12 px-5 pb-5 flex-1 flex flex-col">
                  ...
                  <Button
                    ...
                    className={
                      isFollowing
                        ? 'bg-muted text-foreground border border-border/80 hover:bg-red-50 hover:text-red-600 hover:border-red-300 transition-colors w-full rounded-full'
                        : 'bg-[#3b49df] hover:bg-[#2f3ab2] text-white w-full rounded-full'
                    }
                  >
                    {isFollowing ? (
